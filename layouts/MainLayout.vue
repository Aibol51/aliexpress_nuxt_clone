<template>
  <div id="MainLayout" class="w-full fixed z-50">
    <div id="TopManu" class="w-full bg-[#FAFAFA] border-b md:block hidden">
    ...
    <div id="MainHeader" class="flex items-center w-full bg-white">
      <div class="flex lg:justify-start justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto">
          ...
          <div class="relative">
            <div class="flex items-center border-2 border-[#FF4646] rounded-md w-full">
              ...
              <button class="flex items-center h-[100%] p-1.5 px-2 bg-[#FF4646]">
                <Icon name="ph:magnifying-glass" size="20" class="text-white" />
              </button>
            </div>
              ...
              <div v-if="false" class="p-1">
                <NuxtLink to="/item/1"
                  ...
                  <div class="flex items-center">
                    <img class="rounded-md" width="40" src="https://picsum.photos/id/82/300/300" alt="">
        ...
        <NuxtLink to="/shoppingcart" class="flex items-center">
          <button class="relative md:block hidden" @mouseenter="isCardHover = true" @mouseleave="isCardHover = false">
            <span
            ...
            <div class="min-w-[40px]">
              <Icon name="ph:shopping-cart-simple-light" size="33" :color="isCardHover ? '#FF4646' : ''" />
            </div>
          </button>
        </NuxtLink>
